...
- mapping_launch.py: Provides /odometry/filtered and TF tree
- navigation_launch.py: Provides Nav2 stack (navigate_to_pose action server)
- nav2_complete.launch.py: Provides higher-level autonomy stack

Topics:
- /odometry/filtered: Robot pose (mapping_launch.py EKF sensor fusion)
- /navigate_to_pose: Action server (navigation_launch.py bt_navigator)
- /cmd_vel: Velocity commands published by Nav2 controller
"""
...
class NavigationManager(Node):
    ...
    def __init__(self):
        ...
        # Parameters - must match nav2_complete.launch.py
