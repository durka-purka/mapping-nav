...
- mapping_launch.py: Provides TF frames (base_link, map from EKF/RTAB-Map)

Frames Available:
- map: Global frame from RTAB-Map SLAM (mapping_launch.py)
- base_link: Robot center (broadcast by mapping_launch.py)
- start_frame: Created by this node (child of map, at robot's initial pose)

Topics:
- /initialpose: Sets the robot's initial pose in map frame (can be from RViz or external node)
- /tf: Broadcasts start_frame as static transform child of map
"""
...
class StartFrameReference(Node):
    ...
    def __init__(self):
        ...
        # Note: map frame from RTAB-Map (mapping_launch.py)
        # base_link frame is robot center (mapping_launch.py)
        # TF transforms broadcast by mapping_launch.py (EKF node)
        ...
        self.initial_pose_sub = self.create_subscription(
            PoseStamped,
            '/initialpose',  # Can be set via RViz or by external node (in map frame)# From RViz or initial localization
