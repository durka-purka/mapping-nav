...
- navigation_launch.py: Provides /global_costmap/costmap (from depth camera PointCloud2)

Costmap Source (from navigation_launch.py):
- Topic: /global_costmap/costmap (OccupancyGrid)
- Obstacle Source: /camera/camera/depth/color/points (RealSense depth PointCloud2)
- Frame: map (RTAB-Map global frame)
...
class FrontierExplorer(Node):
    ...
    def __init__(self):
        ...
        self.costmap_sub = self.create_subscription(
            OccupancyGrid,
            self.costmap_topic,  # /global_costmap/costmap from navigation_launch.py
        ...
        self.odom_sub = self.create_subscription(
            Odometry,
            '/odometry/filtered',  # EKF sensor fusion from mapping_launch.py
            self.odom_callback,
            reliable_qos
        )
