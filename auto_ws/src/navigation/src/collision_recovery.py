...
- mapping_launch.py: Provides /odometry/filtered (EKF sensor fusion for stuck detection)
- navigation_launch.py: Provides Nav2 recovery behaviors (backup, spin)

Topics:
- /odometry/filtered: Robot pose from EKF (used to detect lack of forward progress)
- /cmd_vel: Published to execute manual recovery maneuvers
- Recovery actions: backup, spin (provided by nav2_behaviors from navigation_launch.py)
"""
